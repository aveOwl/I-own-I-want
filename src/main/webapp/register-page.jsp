...
<div class="wrapper" ng-controller="MainController as ctrl">
    <form name="frm" action="registrationServlet" method="post" class="register" onSubmit="return myFunc()" novalidate>
        ...
        <div>
            ...
            <input type="password" name="password" id="password" ng-minlength="5" ng-model="ctrl.user.password"
                   required/>
        ...
        <div>
            ...
            <input type="password" name="confirmPassword" id="confirmPassword" ng-model="ctrl.user.confirmPassword"
